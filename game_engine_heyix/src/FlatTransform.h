...
namespace FlatPhysics {
	...
	public:
		...
		static void TransformVectors(const std::vector<Vector2>& vectors, std::vector<Vector2>& out, const FlatTransform& transform);
		static FlatTransform Invert(const FlatTransform& transform);
	public:
		Vector2 position;
		float sin;
		float cos;
